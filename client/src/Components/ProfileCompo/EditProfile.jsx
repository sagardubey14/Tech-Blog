...
function EditProfile() {
  ...
  const submitAnswer = async() => {
    console.log(answer);
    try {
      const response = await axios.post('http://localhost:3001/update/ans' , {answer: answer},{
  ...
  const handleEmailUpdate= async()=>{
    try {
      const response = await axios.post('http://localhost:3001/update/email' , {newEmail: newEmail},{
        withCredentials:true
      } )
      console.log(response);
